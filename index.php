...
<head>
  ...
  <!-- <link rel="shortcut icon" type="imagex/png" href="./img/icon_programacao_visual.png"> -->
  <!-- <link href="public/css/fontawesome-free-6.5.2/css/fontawesome.css" rel="stylesheet">
  <link href="public/css/fontawesome-free-6.5.2/css/brands.css" rel="stylesheet">
  <link href="public/css/fontawesome-free-6.5.2/css/solid.css" rel="stylesheet"> -->
...
<body>
  ...
  <nav class="navbar navbar-expand-lg bg-body-tertiary">
    <div class="container-fluid">
      ...
      <a class="navbar-brand" href="/"><img src="public/img/logo2.png" alt="Logo" style="width:40px" class="d-inline-block align-text-top"> MakeSoft - Solutions</a>
        ...
        <div class="offcanvas-md offcanvas-end bg-body-tertiary" tabindex="-1" id="sidebarMenu" aria-labelledby="sidebarMenuLabel">
          ...
          <div class="offcanvas-body d-md-flex flex-column p-0 pt-lg-3 overflow-y-auto">
            ...
            <ul class="nav flex-column mb-auto">
              <li class="nav-item">
                <a class="nav-link d-flex align-items-center gap-2" href="https://www.instagram.com/MakeSoft_Solutions_" target="_blank">
      ...
      <div class="col-lg-12 col-md-12">
        <footer class="py-3 my-4">
          <ul class="nav justify-content-center border-bottom pb-3 mb-3">
            ...
            <li class="nav-item">
              <a class="hoverYellow nav-link px-2 text-body-secondary" href="https://api.whatsapp.com/send/?phone=5537991154972" target="_blank">
                <i class="fa-brands fa-whatsapp"></i> (37) 99115-4972
              </a>
            </li>
          </ul>
