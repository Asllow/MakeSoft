        ...
        <section class="section" id="equipe">
            <div class="container grid">
                ...
                <div class="card">
                    ...
                    <div class="text">
                        <p>O potencial hidrogênico(pH) de uma solução aquosa é medido por meio da concentração de íons
                            de hidrogênio nessa solução, é representado por uma faixa que vai de 0 a 14, sendo
                            consideradas soluções acidas números menores que 7, neutras iguais a 7 e básicas, maiores
                            que 7. Para a vida na água se manter, o pH deve estar entre 6 e 9, níveis diferentes desses
                            levam a morte dos organismos marinhos. Os mesmos níveis se aplicam a água própria para o
                            consumo. Nos últimos anos os oceanos e aquíferos estão apresentando um pH acido, que ocorre
                            principalmente a partir da absorção de CO₂ vindo da atmosfera e produzido pelo ser humano.
                            Esse fenômeno impacta tanto na vida marinha, prejudicando o desenvolvimento e a reprodução
                            dos seres, quanto na humana, com a redução de peixes e outras fontes de alimentos,
                            atrapalhando a alimentação e emprego de milhões de pessoas. O monitoramento do pH das águas
                            mostra a sua importância com base nas informações acima, visando proteção e restauração da
                            vida aquática.</p>
                    </div>
                    <div class="hold-button">
                ...
                <div class="card">
                    ...
                    <div class="text">
                        <p>A temperatura da água é um dos fatores que mais interfere na preservação e conservação de
                            ...
                            temperatura específicas, contém a proliferação de algas e influencia migrações e reprodução
                        ...
                        <p>Além disso, a medição da temperatura aquática ajuda na interpretação do impacto do
                            aquecimento global e da poluição térmica nos corpos d'água e na gestão de recursos hídricos.
                            Os esforços para monitorar e controlar os níveis da temperatura da água são vitais para a
                            saúde dos ecossistemas presentes na água e a sustentabilidade ambiental.</p>
                    </div>
                    <div class="hold-button">
                        <a class="button" href="{{ route('era.grafico', 'temperatura') }}">Gráfico de Temperatura</a>
                    </div>
                </div>
                <div class="card">
                    <h3 class="title">Turbidez</h3>
                    <div class="text">
                        <p>Turbidez da água é a medida da transparência da água e indica a quantidade de partículas em
                            suspensão que estão presentes. Ela é um fator de monitoramento importante para a avaliação
                            da qualidade da água, tanto para o consumo e uso em processos industriais, quanto para a
                            vida presente em ecossistemas aquáticos. Sedimentos, como partículas de solo que entram na
                            água devido à erosão ou atividades humanas, matéria orgânica (folhas, galhos e outros
                            detritos), microorganismos e poluentes industriais são fatores que interferem na claridade
                            da água. A ausência de acompanhamento preventivo gera maiores gastos com processos de
                            tratamento de água. A medição é feita por meio de um turbidímetro, que avalia a quantidade
                            de luz refletida pelas partículas em suspensão e se dá em unidades de NTU (Unidades
                            Nefelométricas de Turbidez). Para o consumo humano, a OMS indica que a turbidez da água não
                            exceda 5 NTU e, idealmente, seja inferior a 1 NTU. E para corpos d'água naturais, varia de
